...
from misc_util import set_global_seeds, explained_variance
from subproc_vec_env import SubprocVecEnv

from utils import discount_with_dones
from utils import Scheduler, make_path, find_trainable_variables, EpisodeStats
...
class Model(object):
    ...
    def __init__(self, policy, ob_space, ac_space, nenvs, nsteps, nstack, num_procs,
                 ...
                 alpha=0.99, epsilon=1e-5, total_timesteps=int(80e6), lrschedule='linear', optimizer='adam'):
...
def learn(policy, env, seed, nsteps=5, nstack=4, total_timesteps=int(80e6), vf_coef=0.5, ent_coef=0.01,
          ...
          max_episode_length=None, optimizer=None):
    ...
    model = Model(
        ...
        total_timesteps=total_timesteps, lrschedule=lrschedule, optimizer=optimizer)
